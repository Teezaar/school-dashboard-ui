...
const schema = z.object({
    ...
    firstName: z
        .string()
        .min(2, { message: "اسم اول باید حداقل 2 کاراکتر باشد" })
    ...
    address: z
        .string()
        .min(10, { message: "آدرس منزل حداقل 10 کاراکتر و الزامی است" }),
    birthday: z.date({ message: "تاریخ تولد الزامی است" }),
    sex: z.enum(["male", "female"], { message: "جنسیت را مشخص کنید" }),
    grade: z.enum(["کارشناسی", "ارشد", "دکترا"], {
        message: "مقطع را مشخص کنید",
    }),
...
const StudentForm = ({ type, data }: StudentFormProps) => {
    ...
    return (
        <form className="flex flex-col gap-6" onSubmit={onSubmit}>
            <h1 className="text-2xl font-semibold">ایجاد حساب دانشجو</h1>
